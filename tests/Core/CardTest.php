...
class CardTest extends TestCase
{
  ...
  public function testSort()
  {
    ...
    // rem : la syntaxe n'est pas intuitive... (voir https://www.php.net/manual/fr/function.usort.php)
    usort($cards,  array("App\Core\Card", "cmp"));

    // vérifie que le tableau $cards a bien été modifié par usort
    // dans la table ASCII, les chiffres sont avant les lettres de l'alphabet
